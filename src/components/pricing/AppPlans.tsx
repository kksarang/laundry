    ...
    <section className="space-y-12">
      {showHeader && (
        <div className="max-w-xl space-y-4">
          ...
          <h2 className="font-display text-2xl font-semibold text-ink sm:text-3xl md:text-5xl">
      ...
      <div className="flex flex-col gap-5 rounded-[1.5rem] border border-theme bg-[var(--ink)] px-5 py-7 text-white sm:px-6 sm:py-8 md:flex-row md:items-center md:justify-between md:px-10">
        <div className="max-w-lg space-y-2">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--accent)]">Best value</p>
          <h3 className="font-display text-xl font-semibold sm:text-2xl md:text-3xl">{appBundle.name}</h3>
